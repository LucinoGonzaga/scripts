...
class PHPMailer
{
     ...
     * Returns '10.67.24.186.localdomain' if unknown.
     * @access protected
     * @return string
     */
    protected function serverHostname()
    {
        $result = '10.67.24.186.localdomain';
